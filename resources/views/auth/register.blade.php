  ...
  <div class="cotneiner">
    <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="inputForm">  
            ...
            {{-- <x-text-input placeholder="Enter your Email" id="email" class="input" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" /> --}}
            <x-text-input placeholder="Enter your Name" id="name" class="input" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="inputForm">
            ...
            <x-text-input placeholder="Enter your Password" id="password" class="input"
                            type="password"
                            name="password"
        ...
        <div class="inputForm">
            ...
            <x-text-input placeholder="Enter your Confirm Password" id="password_confirmation" class="input"
                            type="password"
                            name="password_confirmation" required autocomplete="new-password" />
        </div>
        <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
        ...
        <a style="text-decoration:none;font-size: 14px;font-weight: 500;color: #2d79f3;" class="p" href="{{ route('login') }}">
            {{ __('Already registered?') }}
        </a>
